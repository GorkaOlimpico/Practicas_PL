...
public class Impresion extends ProcesamientoPorDefecto{
	...
	public void procesa(Lista_dec_una lDecs_una) {
		lDecs_una.dec().procesa(this);
		
	}

	public void procesa(Lista_dec_muchas lDecs_muchas) {
	...
	public void procesa(T_int tipo_int) {
		System.out.print("int");
	}

	
	public void procesa(T_real tipo_real) {
		System.out.print("real");
	}
	
	public void procesa(T_bool tipo_bool) {
