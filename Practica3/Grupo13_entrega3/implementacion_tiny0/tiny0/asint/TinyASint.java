...
public class TinyASint {
	...
	public static class Lista_dec_una extends LDecs {
		private Dec dec;

		public Lista_dec_una(Dec dec) {
			super();
			this.dec = dec;
		}
	...
	public static class Lista_dec_muchas extends LDecs {
		private Dec dec;
		private LDecs ldecs;

		public Lista_dec_muchas(LDecs ldecs, Dec dec) {
			super();
			this.dec = dec;
			this.ldecs = ldecs;
		}
	...
	public LDecs lista_dec_una(Dec dec) {
		return new Lista_dec_una(dec);
	}

	public LDecs lista_dec_muchas(LDecs ldecs, Dec dec) {
		return new Lista_dec_muchas(ldecs, dec);
	}
