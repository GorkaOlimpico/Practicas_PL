...
import asint.TinyASint.Param_muchas;
import asint.TinyASint.Param_una;
...
import asint.TinyASint.Campo_muchas;
import asint.TinyASint.Campo_una;
...
public interface Procesamiento {
	...
	void procesa(Tipo_Pointer tipo_Puntero);
	void procesa(Tipo_Array tipo_Array);
	void procesa(Tipo_Record tipo_Reg);
	void procesa(Campo_una lCampos_uno);
	void procesa(Campo_muchas lCampos_muchos);
	...
	void procesa(Param_muchas lParams_muchos);
	void procesa(Param_una lParams_uno);
	...
	void procesa(Dec_proc dec_Proc_sin_params);
