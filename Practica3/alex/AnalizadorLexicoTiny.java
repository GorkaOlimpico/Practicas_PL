...
public class AnalizadorLexicoTiny {
   ...
   private void transita(Estado sig) throws IOException {
	   //no añade al lexema ni los espacios, ni los tabuladores, ni los saltos de linea
     if (sigCar != 9 && sigCar != 32 && sigCar != 10)
   ...
   private void error() {
	   lex.append((char)sigCar);
	   this.errores.errorLexico(filaActual, columnaActual, lex.toString());
   }
