...
import asintAsc.AnalizadorSintacticoTiny;
import asinDesc.AnalizadorSintacticoDescTiny;
...
public class Main {
	   public static void main(String[] args) throws Exception {
		 ...
		 if(args[1].toString().equalsIgnoreCase("desc")) {
			 ...
			 AnalizadorSintacticoTiny asintAsc = new AnalizadorSintacticoTiny(alex);
